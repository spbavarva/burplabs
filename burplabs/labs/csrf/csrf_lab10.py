...
LAB_NAME = "CSRF where Referer validation depends on header being present"
...
def run(url, payload, proxies=None):
    ...
    print(Fore.WHITE + f"""1. Craft an HTML form for changing the email address with an auto-submit script and a meta tag that drops the Referer header from the request\n2. Deliver the exploit to the victim\n3. The victim's email will be changed after they trigger the exploit\n""")
