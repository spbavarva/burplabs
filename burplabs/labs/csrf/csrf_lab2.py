...
LAB_NAME = "CSRF where token validation depends on request method"
...
def run(url, payload, proxies=None):
    ...
    print(Fore.WHITE + f"""1. Craft an HTML form for changing the email address with an auto-submit script and use the GET method rather than POST as the form method\n2. Deliver the exploit to the victim\n3. The victim's email will be changed after they trigger the exploit\n""")
