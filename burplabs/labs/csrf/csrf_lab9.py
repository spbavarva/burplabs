...
LAB_NAME = "SameSite Lax bypass via cookie refresh"
...
def run(url, payload, proxies=None):
    ...
    print(Fore.WHITE + f"""1. Craft an HTML form for changing the email address with a script that opens a new tab to force the victim to refresh their cookie and submit the form after a few seconds to make sure that the redirection occurred\n2. Deliver the exploit to the victim\n3. The victim's email will be changed after they trigger the exploit\n""")
