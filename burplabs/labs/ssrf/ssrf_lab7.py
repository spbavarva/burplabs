...
LAB_NAME = "SSRF with whitelist-based input filter"
...
def run(url, payload, proxies=None):
    ...
    print(Fore.WHITE + f"""1. Inject payload into 'stockApi' parameter to delete carlos using SSRF with whitelist-based input filter bypass\n2. Check that carlos doesn't exist anymore in the admin panel\n""")
    ...
    print(Fore.WHITE + "[+] Injecting payload to delete carlos using SSRF with whitelist-based input filter bypass")
